...
WHERE
  ...
  try {
    ...
    if (!$studentInfo) {
      ...
      $year_level             = $studentInfo['year_level_id'] ?? '';
...
<body>
            ...
            <div class="container">             
                ...
                <div class="form-container">
                  ...
                  <div class="button-container">
                    <button class="button back-page btn-clear" data-href="student-information" title="Go back to student info.">Back</button>
    ...
    <div id="editStudentModal" class="modal">
        <div class="modal-content">
            ...
            <form id="addStudentForm" action="modules/student_info/processes/submit_student_info.php" method="POST">
            <input type="hidden" name="form_type" value="update_student_info">
