...
<html lang="en">
  <head>
      ...
      <link rel="stylesheet" href="modules/user_information/css/user_list.css">
  ...
  <body>
              ...
              <div class="container">
                  ...
                  <div class="dataTables_wrapper">
                      <div class="table-wrapper">
                          ...
                          <p class="note"> Note: Click on the User ID to edit the user information.</p>
                      </div> <!--- Table wrapper -->
                  </div> <!--- DataTables wrapper -->
                  <div class="button-container">
                      <button class="button" id="deleteBtn" title="Click here to remove student/s.">Remove User</button>
                  </div>
              </div>
          </div> <!--- Container -->
      </div> <!--- Content wrapper -->
      ...
      <div id="enhancedDeleteModal" class="modal">
        <div class="modal-content">
          ...
          <p>You are about to delete the selected usesr(s). Please provide a reason for this action.</p>
          ...
          <div class="modal-buttons" style="margin-top: 20px;">         
            <button id="cancelDeleteWithReason" class="button cancel-delete btn-back">Cancel</button>
      ...
      <script src="modules/user_information/js/user_list.js"></script>
