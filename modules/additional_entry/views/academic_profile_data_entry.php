...
<html lang="en">
    ...
    <body>
                            ...
                            <div class="entry-content">
                                <div class="form-group">
                                    ...
                                    <select id="metricSelect" onchange="handleMetricChange()">
                                        ...
                                        <option value="BoardSubjects">Board Subjects</option>
                                        <option value="GeneralSubjects">General Subjects</option>
                                        <option value="TypeOfRating">Type of Rating</option>
                                        <option value="TypeOfSimulation">Type of Simulation</option>
                                    </select>
                                </div>
        ...
        <div class="modal" id="validationModal">
            ...
            <script src="modules/additional_entry/js/academic_profile_entry.js"></script> 
            <script src="modules/additional_entry/js/general_additional_entry.js"></script> <!--FOR GENERALLY USED FUNCTIONS-->
            <script>
                window.userSession = {
