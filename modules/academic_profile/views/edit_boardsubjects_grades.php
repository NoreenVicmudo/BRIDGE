...
LEFT JOIN
    student_board_subjects_grades AS sb ON si.student_number = sb.student_number
WHERE
    si.is_active = 1
    AND ss.is_active = 1
    ...
    foreach ($studentInfo as $row) {
      ...
      if (!empty($row['subject_id'])) {
        $grades[$row['subject_id']] = $row['subject_grade'];
      }
    }
...
<body>
    ...
    <?php echo renderSidebar(); ?>
        ...
        <div class="content">
          <div class="container-wrapper">
            <div class="container">
              <h2>Student Grades in Board Subject Overview</h2>
              <div class="form-container">
                  ...
                  <div id="subjectGradesList">
                    ...
                    if (!empty($subjects)) {
                      foreach ($subjects as $subject_id => $subject_name) {
                        $grade = isset($grades[$subject_id]) ? $grades[$subject_id] : '';
                ...
                <div class="button-container">
                  <button class="button back-page btn-clear" data-href="board-subject-grades" title="Go back to student info.">Back</button>
    ...
    <!-- Edit Student Modal TOOOOOOOOOOOOOOOOOMORROW -->
    <div id="editStudentModal" class="modal">
      <div class="modal-content">
        <h2>Edit Board Subject Grade</h2>
        ...
        <form id="addStudentForm" action="modules/academic_profile/processes/submit_academic_profile.php" method="POST">
          ...
          <input type="hidden" name="form_type" value="board_subject">
          ...
          <div class="form-group full-width">
            <label for="subject_grade">Final Grade:</label>
            <input type="text" name="subject_grade" id="subject_grade" required>
          </div>
    ...
    <script>
        ...
        if (studentGrades[subjectId]) {
            $('#subject_grade').val(studentGrades[subjectId]);
        } else {
            $('#subject_grade').val('');
        }
    });
