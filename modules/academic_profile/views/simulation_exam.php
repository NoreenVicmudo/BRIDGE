...
$_SESSION['filter_metric'] = 'SimExam';
...
<body>
            ...
            <div class="container-wrapper">
                <div class="container">
                    ...
                    <div class="dataTables_wrapper">
                            ...
                            <table id="myTable" class="display nowrap">
                                <thead>
                                    <tr class="top">
                                        ...
                                        <th>Student ID</th>
                                        <th>Student Name</th>
                                        <?php foreach ($simulations as $simulationName) {
                                            echo "<th>$simulationName</th>";
                                        } ?>
                                    </tr>
                                </thead>
                                <tbody>                       
                        ...
                        <?php if ($_SESSION['level'] != 0) { ?>
                            <p class="note"> Note: Click on the Student Ikita D to edit the student information.</p>
                        <?php }?>
                        </div> <!--- Table wrapper -->
    ...
    <div id="addStudentModal" class="modal">
        <div class="modal-content">
            <h2>Add Student Simulation Exam Results</h2>
            ...
            <div id="findStudentSection" class="form-group full-width" style="display: none;">
                ...
                <div class="modal-buttons">
                    ...
                    <button id="checkStudentBtn" type="button" data-href="edit-simulation-exam-results">Check<div class="loader" id="loader" style="display: none;"></div></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const formData = new FormData();
                    ...
                    fetch('modules/academic_profile/processes/filter_table_sim.php', {
                        method: "POST",
                        body: formData
                    })
