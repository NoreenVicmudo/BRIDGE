...
$_SESSION['filter_metric'] = 'Recognition';
?>
...
<body>
            ...
            <div class="form-container">
                ...
                <div class="form-group">
                    ...
                    <select id="filterCollege" onchange="populateFilterPrograms()">
                        <option value="" disabled selected>Select College</option></select>
                </div>
    ...
    <div id="addStudentModal" class="modal">
        <div class="modal-content">
            <h2>Add Student Academic Recognition</h2>
            ...
            <div id="findStudentSection" class="form-group full-width" style="display: none;">
                ...
                <div class="modal-buttons">
                    ...
                    <button id="checkStudentBtn" type="button" data-href="edit-academic-recognition">Check<div class="loader" id="loader" style="display: none;"></div></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const formData = new FormData();
                    ...
                    fetch('modules/academic_profile/processes/filter_table_recog.php', {
                        method: "POST",
                        body: formData
                    })
