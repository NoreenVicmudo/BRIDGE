...
$_SESSION['filter_metric'] = 'BoardGrades';
    ...
    <?php echo renderSidebar(); ?>
        ...
        <div class="content">
            <div class="container-wrapper">
                <div class="container">
                    <h2>Grades in Board Subjects</h2>
    ...
    <div id="filterModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-buttons">
                <button onclick="closeFilterModal()" class="back-page btn-clear">Cancel</button>
        ...
        <div class="modal-content">
            ...
            <div id="findStudentSection" class="form-group full-width" style="display: none;">
                ...
                <div class="modal-buttons">
                    ...
                    <button id="checkStudentBtn" type="button" data-href="edit-board-subject-grades">Check<div class="loader" id="loader" style="display: none;"></div></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const formData = new FormData();
                    ...
                    fetch('modules/academic_profile/processes/filter_table_board.php', {
                        method: "POST",
                        body: formData
                    })
