...
$_SESSION['filter_metric'] = 'Attendance';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <?php echo renderSidebar(); ?>
        ...
        <div class="content">
            <div class="container-wrapper">
                <div class="container">
                    <h2>Attendance in Review Classes</h2>
        ...
        <div class="modal-content">
            ...
            <div id="findStudentSection" class="form-group full-width" style="display: none;">
                ...
                <div class="modal-buttons">
                    ...
                    <button id="checkStudentBtn" type="button" data-href="edit-review-classes-attendance">Check<div class="loader" id="loader" style="display: none;"></div></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const formData = new FormData();
                    ...
                    fetch('modules/academic_profile/processes/filter_table_attendance.php', {
                        method: "POST",
                        body: formData
                    })
