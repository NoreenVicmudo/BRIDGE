                            ...
                            <table id="myTable" class="display nowrap">
                                <thead>
                                    <tr class="top">
                                        ...
                                        <?php } ?><th>Student ID</th>
                                        <th>Student Name</th>
                                        <?php foreach ($gwaHeaders as $header) {
                                            echo "<th>$header</th>";
                                        } ?>
                                    </tr>
                                </thead>
        ...
        <div class="modal-content">
            ...
            <div id="findStudentSection" class="form-group full-width" style="display: none;">
                ...
                <div class="modal-buttons">
                    ...
                    <button id="checkStudentBtn" type="button" data-href="edit-general-weighted-average">Check<div class="loader" id="loader" style="display: none;"></div></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const formData = new FormData();
                    ...
                    fetch('modules/academic_profile/processes/filter_table_gwa.php', {
                        method: "POST",
                        body: formData
                    })
