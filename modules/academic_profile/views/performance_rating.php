...
$_SESSION['filter_metric'] = 'PerformanceRating';
                            ...
                            <table id="myTable" class="display nowrap">
                                <thead>
                                    <tr class="top">
                                        ...
                                        <th>Student ID</th>
                                        <th>Student Name</th>
                                        <?php foreach ($ratings as $ratingName) {
                                            echo "<th>$ratingName</th>";
                                        } ?>
                                    </tr>
                                </thead>
                                <tbody>                          
        ...
        <div class="modal-content">
            ...
            <div id="findStudentSection" class="form-group full-width" style="display: none;">
                ...
                <div class="modal-buttons">
                    ...
                    <button id="checkStudentBtn" type="button" data-href="edit-performance-rating">Check<div class="loader" id="loader" style="display: none;"></div></button>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const formData = new FormData();
                    ...
                    fetch('modules/academic_profile/processes/filter_table_perf.php', {
                        method: "POST",
                        body: formData
                    })
