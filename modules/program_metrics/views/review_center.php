...
$_SESSION['filter_metric'] = 'ReviewCenter';
?>
        ...
        <div class="modal-content">
            ...
            <div id="findStudentSection" class="form-group full-width" style="display: none;">
                ...
                <div class="modal-buttons">
                    ...
                    <button id="checkStudentBtn" type="button" data-href="edit-student-review-center">Check<div class="loader" id="loader" style="display: none;"></div></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const formData = new FormData();
                    ...
                    fetch('modules/program_metrics/processes/filter_table_review.php', {
                        method: "POST",
                        body: formData
                    })
