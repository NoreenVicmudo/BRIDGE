...
$_SESSION['filter_metric'] = 'MockScores';
?>
                            ...
                            <table id="myTable" class="display nowrap">
                                <thead>
                                    <tr class="top">
                                        ...
                                        <?php } ?>
                                        <th class="select-column hidden">Student Number</th>
                                        <th class="select-column hidden">Name</th>
        ...
        <div class="modal-content">
            ...
            <div class="form-container">
                ...
                <div class="form-group">
                    ...
                    <select name="filterProgram" id="filterProgram" class="form-select">
        ...
        <div class="modal-content">
            ...
            <div id="findStudentSection" class="form-group full-width" style="display: none;">
                ...
                <div class="modal-buttons">
                    ...
                    <button id="checkStudentBtn" type="button" data-href="edit-mock-board-scores">Check<div class="loader" id="loader" style="display: none;"></div></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const formData = new FormData();
                    ...
                    fetch('modules/program_metrics/processes/filter_table_mock.php', {
                        method: "POST",
                        body: formData
                    })
