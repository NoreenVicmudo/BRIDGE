        ...
        foreach ($studentInfo as $row) {
            if (!$studentData) {
                $studentData = [
                    ...
                    'review_center' => $row['review_center']
                ];
            ...
            <div class="container">
              ...
              <div class="form-container">
                ...
                <div class="form-group full-width">
                  <label for="studentField1">Review Center:</label>
                  <input type="text" name="studentField1" id="studentField1" value="<?php echo htmlspecialchars($studentData['review_center'] ?? ''); ?>" readonly>
                </div>
                <div class="button-container">
                  <button class="button back-page btn-clear" data-href="student-review-center" title="Go back to Review Center.">Back</button>
    ...
    <div id="editStudentModal" class="modal">
        <div class="modal-content">
            ...
            <form id="addStudentForm" action="modules/program_metrics/processes/submit_program_metrics.php" method="POST">
              ...
              <div class="form-group full-width"> 
                <label for="reviewCenter">Review Center: </label>
                <input type="text" name="reviewCenter" id="reviewCenter" placeholder="Name of Review Center" value="<?php echo htmlspecialchars($studentData['review_center'] ?? ''); ?>" required>
              </div>
