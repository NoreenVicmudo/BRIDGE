...
<html lang="en">
    ...
    <body>
        ...
        <div class="form-container shadow-lg rounded-4 bg-white">
            <i class="bi bi-clock-history status-icon warning"></i>
            <h2 class="text-center fw-semibold mb-4">Token Expired</h2>
            <div class="text-center">
                <p class="landing-message">Your token has expired. Please return to create a new request.</p>
