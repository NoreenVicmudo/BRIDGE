...
<html lang="en">
    ...
    <body>
        ...
        <div class="form-container shadow-lg rounded-4 bg-white">
            <i class="bi bi-hourglass-split status-icon info"></i>
            <h2 class="text-center fw-semibold mb-4">Registration Complete!</h2>
            <div class="text-center">
                <p class="landing-message">We will send an email once your account is approved by an administrator.</p>
